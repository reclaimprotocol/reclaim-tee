...
type AttestationResponse struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	AttestationDoc []byte                 `protobuf:"bytes,1,opt,name=attestation_doc,json=attestationDoc,proto3" json:"attestation_doc,omitempty"`
	Success        bool                   `protobuf:"varint,2,opt,name=success,proto3" json:"success,omitempty"`
...
const file_transport_proto_rawDesc = "" +
	...
	"\x0fattestation_doc\x18\x01 \x01(\fR\x0eattestationDoc\x12\x18\n" +
